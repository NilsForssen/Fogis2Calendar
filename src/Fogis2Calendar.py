...
def getDataPage(uName, pWord):
    ...
    with requests.Session() as session:
        ...
        # Log in page
        loginPage = session.get("https://fogis.svenskfotboll.se/Fogisdomarklient/login/Login.aspx", headers=headers, verify=False)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        # Window icon
        root.iconbitmap(resource_path("calendar_icon.ico"))
